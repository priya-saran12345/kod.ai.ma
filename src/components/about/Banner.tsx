...
About            </button>
          ...
          <h1 className="text-5xl md:text-5xl text-white  font-bold text-dark-text leading-tight mb-8">Helping Business 
             <span className="text-[#8FE89C]">Grow.</span>
          </h1>
          
          <p className="text-xl md:text-xl text-white max-w-3xl mx-auto leading-relaxed mb-12">
<span className="text-[#8FE89C]">Kodaima</span> helps businesses streamline operations and grow faster with AI-powered automation.
</p>          
