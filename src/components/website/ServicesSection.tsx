  ...
  return (
    <section className=" py-20 px-12">
      <div className=" mx-auto">
        ...
        {/* Services Grid */}
          <div className=" rounded-2xl mb-8 bg-[#F2F5F8] hover:bg-[#8FE89C] duration-200 p-8 shadow-sm hover:shadow-lg transition-shadow">
        ...
        <div className="grid md:grid-cols-2  gap-8">
          ...
          {/* Web Development */}
          <div className="bg-[#F2F5F8] hover:bg-[#8FE89C] duration-200 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
          ...
          <div className="bg-[#F2F5F8] hover:bg-[#8FE89C] duration-200 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow ">
            ...
            {/* Mock AI Interface */}
            <div className=" rounded-lg p-4 h-40 flex items-center justify-center">
